...
useEffect (()=> {
  ...
  return (
    ...
    text-slate-500'>
        <h1 className='text-center text-2xl rounded-xl text-slate-500 '>{state}</h1>
        <p className='text-sm'>Welcome back! Please sign in to continue</p>

       { state!== 'Login' && <div className='border px-6 py-2 flex items-center gap-2
        rounded-full mt-4'>
            <img src={assets.people} className='w-4'alt="" />
        ...
        rounded-full mt-4'>
            <img src={assets.email_icon} className='w-4 filter brightness-0 invert-0'alt="" />
        ...
        <div className='border px-6 py-2 flex items-center gap-2
        rounded-full mt-4'>
            <img src={assets.lock_icon} className='w-3 filter brightness-0 invert-0'alt="" />
    ...
    <p className='mt-5 text-center'>Already have an account? <span 
     ...
     src={assets.cross_icon} alt="" className='absolute top-5
